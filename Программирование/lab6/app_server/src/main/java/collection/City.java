...
public class City{
    ...
    public City(Long id, String name, Coordinates coordinates, Integer area, Integer population, Double metersAboveSeaLevel, Climate climate, Government government, StandardOfLiving standardOfLiving, Human governor){
