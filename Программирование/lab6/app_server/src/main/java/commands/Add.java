...
public class Add extends Command {
    ...
    public Add(JsonArray parameters, JsonArray arguments) {
    ...
    public Add(String[] parameters, PrintStream stdout, Scanner scanner) throws ArgumentException{
    ...
    public static Help.HelpEntry getHelpEntry() {
        return new Help.HelpEntry("add", "добавляет новый элемент в коллекцию");
    }
}
